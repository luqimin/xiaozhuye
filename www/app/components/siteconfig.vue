                ...
                <div v-if="isvip" class="well well-sm submitSiteWrap">
                    ...
                    <div class="form-inline row addSiteLineTwo">
                        <div class="checkbox col-md-4">
                            <label>
                                <input @change="changIsfocus" v-model="siteIssecret" type="checkbox" id="isSecret"> 是否公开网址
                            </label>
                        </div>
                        <div class="checkbox col-md-4">
                            <label>
                                <input @change="changIsfocus" v-model="siteIsfocus" type="checkbox" id="isDefFocus"> 是否默认高亮
                            </label>
                        </div>
                        <div class="checkbox col-md-4">
